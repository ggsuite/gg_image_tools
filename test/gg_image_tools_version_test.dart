...
void main() {
  group('gg_image_tools_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_image_tools_version.dart');
